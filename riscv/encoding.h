...
#define MATCH_CV_LH 0x10007003
#define MASK_CV_LH 0xfe00707f
#define MATCH_CV_LW 0x20007003
#define MASK_CV_LW 0xfe00707f
#define MATCH_CV_SH 0x5023
#define MASK_CV_SH 0xfe00707f
#define MATCH_CV_SW 0x6023
#define MASK_CV_SW 0xfe00707f
#define MATCH_CV_SW_IMM_INC 0x202b
#define MASK_CV_SW_IMM_INC 0xfe00707f
...
#endif
#ifdef DECLARE_INSN
DECLARE_INSN(cv_mac, MATCH_CV_MAC, MASK_CV_MAC)
DECLARE_INSN(cv_lh, MATCH_CV_LH, MASK_CV_LH)
DECLARE_INSN(cv_lw, MATCH_CV_LW, MASK_CV_LW)
DECLARE_INSN(cv_sh, MATCH_CV_SH, MASK_CV_SH)
DECLARE_INSN(cv_sw, MATCH_CV_SW, MASK_CV_SW)
DECLARE_INSN(cv_sw_imm_inc, MATCH_CV_SW_IMM_INC, MASK_CV_SW_IMM_INC)
DECLARE_INSN(cv_addn, MATCH_CV_ADDN, MASK_CV_ADDN)
DECLARE_INSN(cv_min, MATCH_CV_MIN, MASK_CV_MIN)
DECLARE_INSN(cv_minu, MATCH_CV_MINU, MASK_CV_MINU)
DECLARE_INSN(cv_max, MATCH_CV_MAX, MASK_CV_MAX)
DECLARE_INSN(cv_maxu, MATCH_CV_MAXU, MASK_CV_MAXU)
DECLARE_INSN(cv_extbs, MATCH_CV_EXTBS, MASK_CV_EXTBS)
